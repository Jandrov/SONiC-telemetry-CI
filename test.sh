...
sudo docker exec -it gnmicli ./bin/gnmi_get -xpath_target COUNTERS_DB -xpath interface:Ethernet1/in-errors -target_addr 192.18.0.12:8080 -insecure -logtostderr
