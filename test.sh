...
sudo docker exec -it host1 ping 192.168.1.1 -c50

#Ping desde switch1 a host1
sudo docker exec -it switch1 ping 192.168.1.2 -c50

#Ping desde host1 a host2
sudo docker exec -it host1 ping 192.168.2.2 -c50

#Ping desde host2 a switch2
sudo docker exec -it host2 ping 192.168.2.1 -c50

#Ping desde switch2 a host2
sudo docker exec -it switch2 ping 192.168.2.2 -c50

#Ping desde host2 a host1
sudo docker exec -it host2 ping 192.168.1.2 -c50
